...
class MerchantSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        read_only_fields = ['id', 'api_key', 'credit_limit', 'active', 'created_at']
...
class ProfileSerializer(serializers.ModelSerializer):
    merchant = MerchantSerializer(source='merchant_profile', required=False)

    class Meta:
        model = User
        fields = ['id', 'email', 'username', 'phone', 'is_merchant', 'is_ops', 'merchant']
        read_only_fields = ['id', 'email', 'is_merchant', 'is_ops']
...
class TrackFlowTokenObtainPairSerializer(TokenObtainPairSerializer):
    def validate(self, attrs):
        data = super().validate(attrs)
        data['profile'] = ProfileSerializer(self.user).data
        return data
